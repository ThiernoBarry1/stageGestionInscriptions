...
class RegistrationSauvegardeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('financementAcquisPrecision',TextType::class,[ 'required'=>true])
        ->add('productionTv',TextType::class,[ 'required'=>true])
        ->add('preachatTv',TextType::class,[ 'required'=>true])
        ->add('montantSollicite',TextType::class,[ 'required'=>true])
        ...
        ->add('depotProjetCollectivitePrecision',TextType::class,[ 'required'=>true])
        ...
        ->add('projetDejaPresenteFondsAideDate',TextType::class,[ 'required'=>true])
        ->add('projetDejaPresenteFondsAideTypeAide',TextType::class,[ 'required'=>true])
